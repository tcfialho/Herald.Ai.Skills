...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="spec", description="DotSpec control plane")
    sub = parser.add_subparsers(dest="command", required=True)

    init_p = sub.add_parser("init", help="Create .spec/ and .temp/spec/ structure")
    ...
    status_p = sub.add_parser("status", help="Show DotSpec status")
    add_common(status_p)
    ...
    validate_p = docs_sub.add_parser("validate", help="Validate DotSpec docs")
